...
export default {
  ...
  methods: {
    addCatelogSelect() {
      ...
      crudBrand.addCategorybrandrelation({brandId:this.brandId,categoryId:this.catelogPath[this.catelogPath.length-1]}).then(res => {
    ...
    deleteCateRelationHandle(id, brandId) {
      crudBrand.deleteCategorybrandrelation([id]).then(res => {
        this.getCateRelation();
      })
    ...
    getDataList() {
      ...
      crudBrand.listBrand(params).then(res => {
        if (res && res.code === 0) {
    ...
    updateBrandStatus(data) {
      ...
      crudBrand.updateBrandStatus({ brandId, showStatus }).then(res => {
        this.$message({
          type: "success",
          message: "状态更新成功"
        });
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        crudBrand.deleteBrand(ids).then(res => {
          if (res && res.code === 0) {
            this.$message({
              message: "操作成功",
              type: "success",
